 ...
 * 
 * modified version with "ByReference" Helper class
 * 
...
public interface EdSdkLibrary extends StdCallLibrary {
	...
	/** <i>native declaration : EDSDK\Header\EDSDKTypes.h</i> */
	/**
	 * modified to use EdsBaseRef as inRef
	 */
	...
	/**
	 * modified version of EdsCameraListRef
	 */
  ...
  /**
   * modified version of EdsStreamRef
   */
  ...
  /**
   * modified version of EdsVolumeRef
   */
  ...
  /**
   * modified version of EdsEvfImageRef
   */
   ...
   * @param <T>
   */
	public abstract class EdsObjectByReference<T extends EdsBaseRef> extends
      ByReference {
  ...
  /**
   * modified version of generated EdsBaseRef adds additional "ByReference" type
   * 
   * @author @author Hansi Raber <super@superduper.org>
   *
   */
  ...
  /**
   * modified version of EdsCameraRef
   */
  ...
  /**
   * modified version of EdsDirectoryItemRef
   */
