...
// by the user
public class GetPropertyDescTask extends CanonTask<EdsPropertyDesc> {

    private final EdsPropertyID property;

    public GetPropertyDescTask( final EdsPropertyID property ) {
    ...
    private static class GetEnumPropertyDescTask<T extends DescriptiveEnum<?>> extends CanonTask<T[]> {
