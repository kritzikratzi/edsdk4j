...
public interface TestLibrary extends StdCallLibrary {
	//public static final java.lang.String JNA_LIBRARY_NAME = LibraryExtractor.getLibraryPath("test", true, edsdk.TestLibrary.class);
	//public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(edsdk.TestLibrary.JNA_LIBRARY_NAME, com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS);
	//public static final TestLibrary INSTANCE = (TestLibrary)Native.loadLibrary(edsdk.TestLibrary.JNA_LIBRARY_NAME, edsdk.TestLibrary.class, com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS);
	TestLibrary INSTANCE = (TestLibrary) Native.loadLibrary("dll/EDSDK.dll", TestLibrary.class );
	/// enum values
	...
	public static interface EdsSaveTo {
		...
		public static final int kEdsSaveTo_Both = TestLibrary.EdsSaveTo.kEdsSaveTo_Camera | TestLibrary.EdsSaveTo.kEdsSaveTo_Host;
	};
	/// enum values
	...
	public interface EdsProgressCallback extends Callback {
		NativeLong invoke(NativeLong inPercent, TestLibrary.EdsVoid inContext, IntByReference outCancel);
	};
	/**
	 * -----------------------------------------------------------------------------<br>
	...
	public interface EdsCameraAddedHandler extends Callback {
		NativeLong invoke(TestLibrary.EdsVoid inContext);
	};
	/**
	 * -----------------------------------------------------------------------------<br>
	...
	public interface EdsPropertyEventHandler extends Callback {
		NativeLong invoke(NativeLong inEvent, NativeLong inPropertyID, NativeLong inParam, TestLibrary.EdsVoid inContext);
	};
	/**
	 * -----------------------------------------------------------------------------<br>
	...
	public interface EdsObjectEventHandler extends Callback {
		// CHANGED FROM NATIVELONG to long
		int invoke(NativeLong inEvent, TestLibrary.__EdsObject inRef, TestLibrary.EdsVoid inContext);
	};
	/**
	 * -----------------------------------------------------------------------------<br>
	...
	public interface EdsStateEventHandler extends Callback {
		NativeLong invoke(NativeLong inEvent, NativeLong inEventData, TestLibrary.EdsVoid inContext);
	};
	/**
	 ...
	 */
	int EdsRetain(TestLibrary.__EdsObject inRef);
	/**
	 * Original signature : <code>EdsRelease(EdsBaseRef)</code><br>
	 * <i>native declaration : line 1546</i>
	 */
	int EdsRelease(TestLibrary.__EdsObject inRef);
	/**
	 * Original signature : <code>EdsGetChildCount(EdsBaseRef, EdsUInt32*)</code><br>
	 * <i>native declaration : line 1572</i>
	 */
	int EdsGetChildCount(TestLibrary.__EdsObject inRef, NativeLongByReference outCount);
	/**
	 * Original signature : <code>EdsGetChildAtIndex(EdsBaseRef, EdsInt32, EdsBaseRef*)</code><br>
	 * <i>native declaration : line 1591</i><br>
	 * @deprecated use the safer method {@link #EdsGetChildAtIndex(edsdk.TestLibrary.__EdsObject, com.sun.jna.NativeLong, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	int EdsGetChildAtIndex(TestLibrary.__EdsObject inRef, NativeLong inIndex, PointerByReference outRef);
	/**
	 * Original signature : <code>EdsGetChildAtIndex(EdsBaseRef, EdsInt32, EdsBaseRef*)</code><br>
	 * <i>native declaration : line 1591</i>
	 */
	int EdsGetChildAtIndex(TestLibrary.__EdsObject inRef, NativeLong inIndex, TestLibrary.__EdsObject outRef[]);
	/**
	 * Original signature : <code>EdsGetParent(EdsBaseRef, EdsBaseRef*)</code><br>
	 * <i>native declaration : line 1609</i><br>
	 * @deprecated use the safer method {@link #EdsGetParent(edsdk.TestLibrary.__EdsObject, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	int EdsGetParent(TestLibrary.__EdsObject inRef, PointerByReference outParentRef);
	/**
	 * Original signature : <code>EdsGetParent(EdsBaseRef, EdsBaseRef*)</code><br>
	 * <i>native declaration : line 1609</i>
	 */
	int EdsGetParent(TestLibrary.__EdsObject inRef, TestLibrary.__EdsObject outParentRef[]);
	/**
	 ...
	 * @deprecated use the safer methods {@link #EdsGetPropertySize(edsdk.TestLibrary.__EdsObject, com.sun.jna.NativeLong, com.sun.jna.NativeLong, java.nio.IntBuffer, com.sun.jna.ptr.NativeLongByReference)} and {@link #EdsGetPropertySize(edsdk.TestLibrary.__EdsObject, com.sun.jna.NativeLong, com.sun.jna.NativeLong, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.NativeLongByReference)} instead<br>
	 * @param outDataType @see EdsDataType
	 */
	@java.lang.Deprecated 
	int EdsGetPropertySize(TestLibrary.__EdsObject inRef, NativeLong inPropertyID, NativeLong inParam, IntByReference outDataType, NativeLongByReference outSize);
	/**
	 * Original signature : <code>EdsGetPropertySize(EdsBaseRef, EdsPropertyID, EdsInt32, EdsDataType*, EdsUInt32*)</code><br>
	 * <i>native declaration : line 1643</i>
	 */
	int EdsGetPropertySize(TestLibrary.__EdsObject inRef, NativeLong inPropertyID, NativeLong inParam, IntBuffer outDataType, NativeLongByReference outSize);
	/**
	 ...
	 */
	int EdsGetPropertyData(TestLibrary.__EdsObject inRef, NativeLong inPropertyID, NativeLong inParam, NativeLong inPropertySize, TestLibrary.EdsVoid outPropertyData);
	/**
	 ...
	 */
	int EdsSetPropertyData(TestLibrary.__EdsObject inRef, NativeLong inPropertyID, NativeLong inParam, NativeLong inPropertySize, TestLibrary.EdsVoid inPropertyData);
	/**
	 ...
	 */
	int EdsGetPropertyDesc(TestLibrary.__EdsObject inRef, NativeLong inPropertyID, edsdk.EdsPropertyDesc outPropertyDesc);
	/**
	 * Original signature : <code>EdsGetCameraList(EdsCameraListRef*)</code><br>
	 * <i>native declaration : line 1744</i><br>
	 * @deprecated use the safer method {@link #EdsGetCameraList(edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	 ...
	 */
	int EdsSendStatusCommand(TestLibrary.__EdsObject inCameraRef, NativeLong inStatusCommand, NativeLong inParam);
	/**
	 * Original signature : <code>EdsSetCapacity(EdsCameraRef, EdsCapacity)</code><br>
	 * <i>native declaration : line 1878</i>
	 */
	int EdsSetCapacity(TestLibrary.__EdsObject inCameraRef, edsdk.EdsCapacity.ByValue inCapacity);
	/**
	 * Original signature : <code>EdsGetVolumeInfo(EdsVolumeRef, EdsVolumeInfo*)</code><br>
	 * <i>native declaration : line 1904</i>
	 */
	int EdsGetVolumeInfo(TestLibrary.__EdsObject inVolumeRef, edsdk.EdsVolumeInfo outVolumeInfo);
	/**
	 * Original signature : <code>EdsFormatVolume(EdsVolumeRef)</code><br>
	 * <i>native declaration : line 1920</i>
	 */
	int EdsFormatVolume(TestLibrary.__EdsObject inVolumeRef);
	/**
	 ...
	 */
	int EdsGetDirectoryItemInfo(TestLibrary.__EdsObject inDirItemRef, edsdk.EdsDirectoryItemInfo outDirItemInfo);
	/**
	 * Original signature : <code>EdsDeleteDirectoryItem(EdsDirectoryItemRef)</code><br>
	 * <i>native declaration : line 1968</i>
	 */
	int EdsDeleteDirectoryItem(TestLibrary.__EdsObject inDirItemRef);
	/**
	 * Original signature : <code>EdsDownload(EdsDirectoryItemRef, EdsUInt32, EdsStreamRef)</code><br>
	 * <i>native declaration : line 1991</i>
	 */
	int EdsDownload(TestLibrary.__EdsObject inDirItemRef, NativeLong inReadSize, TestLibrary.__EdsObject outStream);
	/**
	 * Original signature : <code>EdsDownloadCancel(EdsDirectoryItemRef)</code><br>
	 * <i>native declaration : line 2011</i>
	 */
	int EdsDownloadCancel(TestLibrary.__EdsObject inDirItemRef);
	/**
	 * Original signature : <code>EdsDownloadComplete(EdsDirectoryItemRef)</code><br>
	 * <i>native declaration : line 2031</i>
	 */
	int EdsDownloadComplete(TestLibrary.__EdsObject inDirItemRef);
	/**
	 * Original signature : <code>EdsDownloadThumbnail(EdsDirectoryItemRef, EdsStreamRef)</code><br>
	 * <i>native declaration : line 2051</i>
	 */
	int EdsDownloadThumbnail(TestLibrary.__EdsObject inDirItemRef, TestLibrary.__EdsObject outStream);
	/**
	 * Original signature : <code>EdsGetAttribute(EdsDirectoryItemRef, EdsFileAttributes*)</code><br>
	 * <i>native declaration : line 2072</i><br>
	 * @deprecated use the safer methods {@link #EdsGetAttribute(edsdk.TestLibrary.__EdsObject, java.nio.IntBuffer)} and {@link #EdsGetAttribute(edsdk.TestLibrary.__EdsObject, com.sun.jna.ptr.IntByReference)} instead<br>
	 * @param outFileAttribute @see EdsFileAttributes
	 */
	@java.lang.Deprecated 
	int EdsGetAttribute(TestLibrary.__EdsObject inDirItemRef, IntByReference outFileAttribute);
	/**
	 * Original signature : <code>EdsGetAttribute(EdsDirectoryItemRef, EdsFileAttributes*)</code><br>
	 * <i>native declaration : line 2072</i>
	 */
	int EdsGetAttribute(TestLibrary.__EdsObject inDirItemRef, IntBuffer outFileAttribute);
	/**
	 ...
	 */
	int EdsSetAttribute(TestLibrary.__EdsObject inDirItemRef, int inFileAttribute);
	/**
	 ...
	 * @deprecated use the safer methods {@link #EdsCreateFileStream(java.nio.ByteBuffer, int, int, edsdk.TestLibrary.__EdsObject[])} and {@link #EdsCreateFileStream(com.sun.jna.Pointer, int, int, edsdk.TestLibrary.__EdsObject[])} instead<br>
	 ...
	 * @param inDesiredAccess @see EdsAccess
	 */
	int EdsCreateFileStream(ByteBuffer inFileName, int inCreateDisposition, int inDesiredAccess, TestLibrary.__EdsObject outStream[]);
	/**
	 * Original signature : <code>EdsCreateFileStream(const EdsChar*, EdsFileCreateDisposition, EdsAccess, EdsStreamRef*)</code><br>
	 * <i>native declaration : line 2127</i><br>
	 * @param inCreateDisposition @see EdsFileCreateDisposition<br>
	 * @param inDesiredAccess @see EdsAccess
	 */
	int EdsCreateFileStream(Pointer inFileName, int inCreateDisposition, int inDesiredAccess, TestLibrary.__EdsObject outStream[]);
	/**
	 * Original signature : <code>EdsCreateMemoryStream(EdsUInt32, EdsStreamRef*)</code><br>
	 * <i>native declaration : line 2149</i><br>
	 * @deprecated use the safer method {@link #EdsCreateMemoryStream(com.sun.jna.NativeLong, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	 ...
	 */
	int EdsCreateMemoryStream(NativeLong inBufferSize, TestLibrary.__EdsObject outStream[]);
	/**
	 ...
	 * @deprecated use the safer methods {@link #EdsCreateFileStreamEx(short[], int, int, edsdk.TestLibrary.__EdsObject[])} and {@link #EdsCreateFileStreamEx(com.sun.jna.ptr.ShortByReference, int, int, edsdk.TestLibrary.__EdsObject[])} instead<br>
	 * @param inCreateDisposition @see EdsFileCreateDisposition<br>
	 * @param inDesiredAccess @see EdsAccess
	 */
	@java.lang.Deprecated 
	 ...
	 * @param inDesiredAccess @see EdsAccess
	 */
	int EdsCreateFileStreamEx(short inFileName[], int inCreateDisposition, int inDesiredAccess, TestLibrary.__EdsObject outStream[]);
	/**
	 * Original signature : <code>EdsCreateFileStreamEx(const WCHAR*, EdsFileCreateDisposition, EdsAccess, EdsStreamRef*)</code><br>
	 * <i>native declaration : line 2173</i><br>
	 * @param inCreateDisposition @see EdsFileCreateDisposition<br>
	 * @param inDesiredAccess @see EdsAccess
	 */
	int EdsCreateFileStreamEx(ShortByReference inFileName, int inCreateDisposition, int inDesiredAccess, TestLibrary.__EdsObject outStream[]);
	/**
	 ...
	 * @deprecated use the safer method {@link #EdsCreateMemoryStreamFromPointer(edsdk.TestLibrary.EdsVoid, com.sun.jna.NativeLong, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	int EdsCreateMemoryStreamFromPointer(TestLibrary.EdsVoid inUserBuffer, NativeLong inBufferSize, PointerByReference outStream);
	/**
	 * Original signature : <code>EdsCreateMemoryStreamFromPointer(EdsVoid*, EdsUInt32, EdsStreamRef*)</code><br>
	 * <i>native declaration : line 2201</i>
	 */
	int EdsCreateMemoryStreamFromPointer(TestLibrary.EdsVoid inUserBuffer, NativeLong inBufferSize, TestLibrary.__EdsObject outStream[]);
	/**
	 * Original signature : <code>EdsGetPointer(EdsStreamRef, EdsVoid**)</code><br>
	 * <i>native declaration : line 2228</i>
	 */
	int EdsGetPointer(TestLibrary.__EdsObject inStream, PointerByReference outPointer);
	/**
	 * Original signature : <code>EdsRead(EdsStreamRef, EdsUInt32, EdsVoid*, EdsUInt32*)</code><br>
	 * <i>native declaration : line 2251</i>
	 */
	int EdsRead(TestLibrary.__EdsObject inStreamRef, NativeLong inReadSize, TestLibrary.EdsVoid outBuffer, NativeLongByReference outReadSize);
	/**
	 * Original signature : <code>EdsWrite(EdsStreamRef, EdsUInt32, const EdsVoid*, EdsUInt32*)</code><br>
	 * <i>native declaration : line 2275</i>
	 */
	int EdsWrite(TestLibrary.__EdsObject inStreamRef, NativeLong inWriteSize, TestLibrary.EdsVoid inBuffer, NativeLongByReference outWrittenSize);
	/**
	 ...
	 */
	int EdsSeek(TestLibrary.__EdsObject inStreamRef, NativeLong inSeekOffset, int inSeekOrigin);
	/**
	 * Original signature : <code>EdsGetPosition(EdsStreamRef, EdsUInt32*)</code><br>
	 * <i>native declaration : line 2324</i>
	 */
	int EdsGetPosition(TestLibrary.__EdsObject inStreamRef, NativeLongByReference outPosition);
	/**
	 * Original signature : <code>EdsGetLength(EdsStreamRef, EdsUInt32*)</code><br>
	 * <i>native declaration : line 2342</i>
	 */
	int EdsGetLength(TestLibrary.__EdsObject inStreamRef, NativeLongByReference outLength);
	/**
	 * Original signature : <code>EdsCopyData(EdsStreamRef, EdsUInt32, EdsStreamRef)</code><br>
	 * <i>native declaration : line 2366</i>
	 */
	int EdsCopyData(TestLibrary.__EdsObject inStreamRef, NativeLong inWriteSize, TestLibrary.__EdsObject outStreamRef);
	/**
	 ...
	 */
	int EdsSetProgressCallback(TestLibrary.__EdsObject inRef, TestLibrary.EdsProgressCallback inProgressCallback, int inProgressOption, TestLibrary.EdsVoid inContext);
	/**
	 * Original signature : <code>EdsCreateImageRef(EdsStreamRef, EdsImageRef*)</code><br>
	 * <i>native declaration : line 2438</i><br>
	 * @deprecated use the safer method {@link #EdsCreateImageRef(edsdk.TestLibrary.__EdsObject, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	int EdsCreateImageRef(TestLibrary.__EdsObject inStreamRef, PointerByReference outImageRef);
	/**
	 * Original signature : <code>EdsCreateImageRef(EdsStreamRef, EdsImageRef*)</code><br>
	 * <i>native declaration : line 2438</i>
	 */
	int EdsCreateImageRef(TestLibrary.__EdsObject inStreamRef, TestLibrary.__EdsObject outImageRef[]);
	/**
	 ...
	 */
	int EdsGetImageInfo(TestLibrary.__EdsObject inImageRef, int inImageSource, edsdk.EdsImageInfo outImageInfo);
	/**
	 ...
	 */
	int EdsGetImage(TestLibrary.__EdsObject inImageRef, int inImageSource, int inImageType, edsdk.EdsRect.ByValue inSrcRect, edsdk.EdsSize.ByValue inDstSize, TestLibrary.__EdsObject outStreamRef);
	/**
	 ...
	 * @param inImageType @see EdsTargetImageType
	 */
	int EdsSaveImage(TestLibrary.__EdsObject inImageRef, int inImageType, edsdk.EdsSaveImageSetting.ByValue inSaveSetting, TestLibrary.__EdsObject outStreamRef);
	/**
	 * Original signature : <code>EdsCacheImage(EdsImageRef, EdsBool)</code><br>
	 * <i>native declaration : line 2577</i>
	 */
	int EdsCacheImage(TestLibrary.__EdsObject inImageRef, int inUseCache);
	/**
	 * Original signature : <code>EdsReflectImageProperty(EdsImageRef)</code><br>
	 * <i>native declaration : line 2594</i>
	 */
	int EdsReflectImageProperty(TestLibrary.__EdsObject inImageRef);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
	 ...
	 * @deprecated use the safer method {@link #EdsCreateEvfImageRef(edsdk.TestLibrary.__EdsObject, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	NativeLong EdsCreateEvfImageRef(TestLibrary.__EdsObject inStreamRef, PointerByReference outEvfImageRef);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
	 * //  Function:   EdsCreateEvfImageRef<br>
	 ...
	 */
	NativeLong EdsCreateEvfImageRef(TestLibrary.__EdsObject inStreamRef, TestLibrary.__EdsObject outEvfImageRef[]);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
	 ...
	 */
	NativeLong EdsDownloadEvfImage(TestLibrary.__EdsObject inCameraRef, TestLibrary.__EdsObject inEvfImageRef);
	/**
	 * Original signature : <code>EdsSetCameraAddedHandler(EdsCameraAddedHandler, EdsVoid*)</code><br>
	 * <i>native declaration : line 2665</i>
	 */
	int EdsSetCameraAddedHandler(TestLibrary.EdsCameraAddedHandler inCameraAddedHandler, TestLibrary.EdsVoid inContext);
	/**
	 ...
	 */
	int EdsSetPropertyEventHandler(TestLibrary.__EdsObject inCameraRef, NativeLong inEvnet, TestLibrary.EdsPropertyEventHandler inPropertyEventHandler, TestLibrary.EdsVoid inContext);
	/**
	 ...
	 */
	int EdsSetObjectEventHandler(TestLibrary.__EdsObject inCameraRef, NativeLong inEvnet, TestLibrary.EdsObjectEventHandler inObjectEventHandler, TestLibrary.EdsVoid inContext);
	/**
	 ...
	 */
	int EdsSetCameraStateEventHandler(TestLibrary.__EdsObject inCameraRef, NativeLong inEvnet, TestLibrary.EdsStateEventHandler inStateEventHandler, TestLibrary.EdsVoid inContext);
	/**
	 * Original signature : <code>EdsCreateStream(EdsIStream*, EdsStreamRef*)</code><br>
	 * <i>native declaration : line 2755</i><br>
	 * @deprecated use the safer method {@link #EdsCreateStream(edsdk.EdsIStream, edsdk.TestLibrary.__EdsObject[])} instead
	 */
	@java.lang.Deprecated 
	 ...
	 */
	int EdsCreateStream(edsdk.EdsIStream inStream, TestLibrary.__EdsObject outStreamRef[]);
	/**
