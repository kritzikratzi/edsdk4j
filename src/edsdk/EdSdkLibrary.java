...
//	public static final EdSdkLibrary INSTANCE = (EdSdkLibrary)Native.loadLibrary(edsdk.EdSdkLibrary.JNA_LIBRARY_NAME, edsdk.EdSdkLibrary.class, com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS);
	 ...
	 */
	NativeLong EdsSetCapacity(EdSdkLibrary.__EdsObject inCameraRef, edsdk.EdsCapacity.ByValue inCapacity);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
	 ...
	 */
	NativeLong EdsGetImage(EdSdkLibrary.__EdsObject inImageRef, int inImageSource, int inImageType, edsdk.EdsRect.ByValue inSrcRect, edsdk.EdsSize.ByValue inDstSize, EdSdkLibrary.__EdsObject outStreamRef);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
	 ...
	 */
	NativeLong EdsSaveImage(EdSdkLibrary.__EdsObject inImageRef, int inImageType, edsdk.EdsSaveImageSetting.ByValue inSaveSetting, EdSdkLibrary.__EdsObject outStreamRef);
	/**
	 * -----------------------------------------------------------------------------<br>
	 * //<br>
